...
// Backtrace support;
#ifdef _OS_LINUX_
extern uintptr_t __start_jl_enter_interpreter_frame;
extern uintptr_t __stop_jl_enter_interpreter_frame;

extern uintptr_t __start_jl_interpreter_frame;
...
JL_DLLEXPORT int jl_is_enter_interpreter_frame(uintptr_t ip)
{
    return __start_jl_enter_interpreter_frame <= ip && ip <= __stop_jl_enter_interpreter_frame;
}
...
// stack frames. We rely on the compiler not spilling any extra variables to the stack
